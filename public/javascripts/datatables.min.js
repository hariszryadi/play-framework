...
z(p,"aoDrawCallback",g.fnDrawCallback,"admin");z(p,"aoServerParams",g.fnServerParams,"admin");z(p,"aoStateSaveParams",g.fnStateSaveParams,"admin");z(p,"aoStateLoadParams",g.fnStateLoadParams,"admin");z(p,"aoStateLoaded",g.fnStateLoaded,"admin");z(p,"aoRowCallback",g.fnRowCallback,"admin");z(p,"aoRowCreatedCallback",g.fnCreatedRow,"admin");z(p,"aoHeaderCallback",g.fnHeaderCallback,"admin");z(p,"aoFooterCallback",g.fnFooterCallback,"admin");z(p,"aoInitComplete",g.fnInitComplete,"admin");z(p,"aoPreDrawCallback",
g.fnPreDrawCallback,"admin");p.rowIdFn=S(g.rowId);gb(p);var u=p.oClasses;h.extend(u,n.ext.classes,g.oClasses);q.addClass(u.sTable);p.iInitDisplayStart===k&&(p.iInitDisplayStart=g.iDisplayStart,p._iDisplayStart=g.iDisplayStart);null!==g.iDeferLoading&&(p.bDeferLoading=!0,e=h.isArray(g.iDeferLoading),p._iRecordsDisplay=e?g.iDeferLoading[0]:g.iDeferLoading,p._iRecordsTotal=e?g.iDeferLoading[1]:g.iDeferLoading);var v=p.oLanguage;h.extend(!0,v,g.oLanguage);v.sUrl&&(h.ajax({dataType:"json",url:v.sUrl,success:function(a){Ca(a);
